...
public class PacmanGame {
	...
	private static final double MAX_CELLS_PER_SECOND = 20.0; // cells per second
	private static final double ENEMY_SPEED_FACTOR = 0.85; // fraction of above
	private static final double PLAYER_SPEED_FACTOR = 0.8;
	...
	/**
	 * Countdown for number of frames to keep enemies in FRIGHTENED mode. When
	 * active, this prevents the modeCountdown from decrementing.
	 */
...
// TODO: UNCOMMENT THESE LINES AS YOU GET THE GHOSTS IMPLEMENTED...
	...
	/**
	 * Suggested colors for the enemies. This array must be the same length as the
	 * enemies array.
	 * 
	...
	/**
	 * Returns the current value of the counter for the period of time the ghosts
	 * remain frightened
	 * 
	...
	/**
	 * Resets the player and enemies back to their home position and direction,
	 * revives the player, restarts the global mode index and countdown, and
	 * restarts the inactive timers for the enemies.
	 */
	...
	/**
	 * Method invoked once per frame to update all aspects of game, player, and
	 * enemy states.
	 */
	...
	/**
	 * Choose an initial direction for the player or enemy. This just checks up,
	 * left, down, right for a non-wall, in that order.
	 * 
	 * @param row
	 * @param col
	 * @return
