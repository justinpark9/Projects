...
public class RunGame {
	// no ghost
	public static final String[] TEST0 = { "#######", "#*...*#", "#.###.#", "#.....#", "#.#.#.#", "#.#.#.#", "#..S..#",
			"#######", };

	// one ghost
	public static final String[] TEST1 = { "#######", "#*...*#", "#.###.#", "#.....#", "#.#B#.#", "#.#.#.#", "#..S..#",
			"#######", };

	// one ghost, and a tunnel
	public static final String[] TEST2 = { "#######", "#*...*#", "#.###.#", " ..B.. ", "#.#.#.#", "#.#.#.#", "#..S..#",
			"#######", };
	...
	protected static void createAndShow(final PacmanGame maze) {
		...
		panel.setPreferredSize(
				new Dimension(maze.getNumColumns() * PacmanPanel.CELL_SIZE, maze.getNumRows() * PacmanPanel.CELL_SIZE));
