...
public class SimpleTest3 {
	// one ghost
	public static final String[] SIMPLE3 = { "######", "#....#", "#.B..#", "#....#", "#S...#", "######", };
	...
	public static void main(String[] args) {
		...
		// now, if we change the mode to CHASE, since we are already past the midpoint
		// of
		...
		// next update should continue up to center of cell at 1.5 and then change
		// direction
		b.update(SimpleTest.makeDescriptor(game));
		System.out.println(b.getNextCell()); // expected 1, 1
