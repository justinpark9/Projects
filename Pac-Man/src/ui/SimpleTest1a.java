...
public class SimpleTest1a {
	...
	public static final String[] SIMPLE1a = { "#######", "#.....#", "#....S#", "#.....#", "#.....#", "#..B..#",
			"#.....#", "#######", };
	...
	public static void main(String[] args) {
		...
		// Our target in CHASE mode is now Pacman, at (2, 5), so going right to (3, 4)
		// would
		...
		// we are already past the center of our current cell, we can't change direction
		// here)
		System.out.println("----------");
		System.out.println();
		...
		System.out.println(b.getCurrentDirection());
		System.out.println(b.getNextCell());
		// Expected: crossing into our next cell (2, 3) triggers a call to
		// calculateNextCell.
